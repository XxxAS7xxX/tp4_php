    ...
    <tbody>
        ...
        foreach($lesAuteurs as $auteur){
            ...
            echo "<td class='col-md-2'>
                <a href='index.php?uc=auteur&action=update&num=".$auteur->getNum()."' class='btn btn-primary'><i class='fas fa-pen'></i></a>
                <a href='#modalSuppression' data-toggle='modal' data-message='Voulez vous supprimer ce auteur ?' data-suppression='index.php?uc=auteur&action=delete&num=".$auteur->getNum()."' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
            </td>";
            echo "</tr>";
        }
